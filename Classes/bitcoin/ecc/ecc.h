...
/**
 ...
 @param p_publicKey - output
 @param p_privateKey - input
 @return 1 if successfully, 0 if an error occurred.
 */
int ecc_copy_public_key(uint8_t p_publicKey[ECC_BYTES+1], uint8_t p_privateKey[ECC_BYTES]);
